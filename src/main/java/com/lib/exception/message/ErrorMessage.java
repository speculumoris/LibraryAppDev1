...
public class ErrorMessage {
    ...
    public static final String LOAN_NOT_FOUND_MESSAGE ="Loan with id : %d not found" ;
    public static final String RESOURCE_NOT_FOUND_EXCEPTION ="Resource with id : %d not found" ;
